...
const (
	TripStatus_TS_NOT_SPECIFIED TripStatus = 0 // 未定義為0
...
type Trip struct {
	...
	StartPos *Location `protobuf:"bytes,5,opt,name=start_pos,json=startPos,proto3" json:"start_pos,omitempty"` // 加字段靠數字加
	// repeated 類型
	...
	Status          TripStatus  `protobuf:"varint,8,opt,name=status,proto3,enum=TripStatus" json:"status,omitempty"`
	IsPromotionTrip bool        `protobuf:"varint,9,opt,name=isPromotionTrip,proto3" json:"isPromotionTrip,omitempty"` // 老系統沒有就默認false
	// bool isFromLoggedInUser = 10; // 命名邏輯錯誤
	IsFromGuestUser bool `protobuf:"varint,10,opt,name=isFromGuestUser,proto3" json:"isFromGuestUser,omitempty"` // 邏輯正確的命名
}
...
var file_trip_proto_rawDesc = []byte{
	,
	...
	0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x22, 0x44, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69,
	...
	0x01, 0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x2a, 0x5c, 0x0a, 0x0a,
	...
	0x12, 0x08, 0x0a, 0x04, 0x50, 0x41, 0x49, 0x44, 0x10, 0x04, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x3b,
...
var file_trip_proto_goTypes = []interface{}{
	(TripStatus)(0),  // 0: TripStatus
	(*Trip)(nil),     // 1: Trip
	(*Location)(nil), // 2: Location
}
var file_trip_proto_depIdxs = []int32{
	2, // 0: Trip.start_pos:type_name -> Location
	2, // 1: Trip.path_pos:type_name -> Location
	2, // 2: Trip.end_pos:type_name -> Location
	0, // 3: Trip.status:type_name -> TripStatus
